...
<div id="footer">
    <div class="wrapper">
        ...
        ?>
            <?php if(!osc_web_contact_form_disabled()) { ?>
            <li>
        ...
        <?php if( (!defined('MULTISITE') || MULTISITE==0) && osc_get_preference('footer_link', 'bender') !== '0') {
            echo '<div>' . sprintf(__('This website is proudly using the <a target="_blank" title="Osclass Enterprise" href="%s"><strong>Osclass Enterprise</strong></a> classifieds software'), 'https://github.com/MercanoGlobal/Osclass-Enterprise') . '</div>';
        }
        ?>
