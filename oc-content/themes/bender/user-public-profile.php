...
<div id="item-content">
    <div class="user-card">
        ...
        <ul id="user_data">
            <li class="name"><?php echo osc_user_name(); ?> <span style="position:relative;width:20px;float:right;"><?php osc_run_hook('seller_verification_show', osc_user_id()); ?></span></li>
