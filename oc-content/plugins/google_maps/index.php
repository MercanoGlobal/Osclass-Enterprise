...
*/
    ...
    function osc_google_maps_header() {
        echo '<script async defer src="https://maps.googleapis.com/maps/api/js?key='.osc_get_preference('maps_key', 'google_maps').'&callback=initMap" type="text/javascript"></script>';
