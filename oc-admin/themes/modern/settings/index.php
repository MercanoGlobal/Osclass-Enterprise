                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            ...
                            <div class="help-box" style="clear:both; float:none;"><a href="https://php.net/date" target="_blank"><?php _e('Documentation on date and time formatting'); ?></a></div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-controls">
                            <div class="form-label-checkbox">
                                <label>
                                    ...
                                    <?php _e('People will not be able to access the web contact form'); ?>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-controls">
                            <div class="form-label-checkbox">
                                <label>
                                    ...
                                    <?php printf(__('Allow Osclass to run a built-in <a href="%s" target="_blank">cron</a> automatically without setting crontab'), 'https://en.wikipedia.org/wiki/Cron' ); ?>
                                </label>
                            </div>
                        ...
                        <div class="form-controls">
                            <div class="form-label-checkbox">
                                <label>
                                    ...
                                    <?php _e('Allow auto-update of plugins'); ?>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-controls">
                            <div class="form-label-checkbox">
                                <label>
                                    ...
                                    <?php _e('Allow auto-update of themes'); ?>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-controls">
                            <div class="form-label-checkbox">
                                <label>
                                    ...
                                    <?php _e('Allow auto-update of languages'); ?>
                                </label>
                            </div>
                        </div>
                    </div>
