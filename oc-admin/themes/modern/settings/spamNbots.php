                    ...
                    <div class="form-controls">
                        ...
                        <?php
                            ...
                            switch($akismet_status) {
                                ...
                                case 3:
                                    $alert_type = 'warning';
                                    $alert_msg  = sprintf(__('Akismet is disabled, please enter an API key. <a href="%s" target="_blank">(Get your key)</a>'), 'https://akismet.com/signup/');;
                                break;
                            }
                        ?>
                ...
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        <div class="form-label-checkbox">
                            ...
                            <span class="help-box"><?php printf(__('(v3 is not yet supported)')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="form-row">
