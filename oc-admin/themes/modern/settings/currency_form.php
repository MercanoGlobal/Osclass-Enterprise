            ...
            <div class="form-horizontal">
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        ...
                        <span class="help-box"><?php printf(__('Must be a three-character code according to the <a href="%s" target="_blank">ISO 4217</a>'), 'https://en.wikipedia.org/wiki/ISO_4217'); ?></span>
                    </div>
                </div>
                <div class="form-row">
