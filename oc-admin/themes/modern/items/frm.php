...
<div class="grid-row no-bottom-margin">
    <div class="row-wrapper">
        <h2 class="render-title"><?php echo customText('subtitle'); ?> 
        <?php if(osc_item_id() > 0) { ?> #<?php echo osc_item_id(); ?> <?php } ?>
        <span style="font-size: small;"><a target="_blank" href="<?php echo osc_item_url(); ?>"><?php _e('View listing on front'); ?> <i class="fa fa-external-link"></i></a></span></h2>
    </div>
</div>
                    ...
                    <div id="right-side">
                        <div class="well ui-rounded-corners">
                            ...
                            <?php if(osc_item_user_id() > 0) { ?>
                                <div id="contact_edit">
                                    <a target="_blank" href="<?php echo osc_admin_base_url(true); ?>?page=users&action=edit&id=<?php echo osc_item_user_id(); ?>"><?php echo sprintf(__('Edit %s\'s profile'), osc_item_contact_name()); ?> <i class="fa fa-external-link"></i></a>
                                </div>
                            <?php } ?>
                            <div id="contact_info">
                                ...
                                <div class="input-separate-top">
                                    <label><?php ItemForm::show_phone_checkbox(); ?><?php _e('Show phone'); ?></label>
                                </div>
                            </div>
                        </div>
