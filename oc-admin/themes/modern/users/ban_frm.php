            ...
            <div class="form-horizontal">
                ...
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        ...
                        <span class="help-box"><?php _e('(e.g. 192.168.10-20.*, 192.*.*.*, 192.*.20.*, 192.*.10-20.1, 192.168.10.1)'); ?></span>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        ...
                        <span class="help-box"><?php _e('(e.g. *@badsite.com, *@subdomain.badsite.com, *@*badsite.com, *badsite.*, *badsite*, *.com)'); ?></span>
                    </div>
                </div>
                <div class="clear"></div>
