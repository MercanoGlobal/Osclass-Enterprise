        ...
        function doModel()
        {
            switch($this->action) {
                ...
                default:            //default dashboard page (main page at oc-admin)
                                    ...
                                    $this->_exportVariableToView( "numComments", ItemComment::newInstance()->count() );
                                    ...
                                    if(function_exists('disk_free_space')) {
                                        ...
                                        if($freedisk!==false && $freedisk<52428800) { // 52428800 = 50*1024*1024
                                            osc_add_flash_error_message(_m('You have very little free space left, users will not be able to upload images...'), 'admin');
                                        }
                                    }
