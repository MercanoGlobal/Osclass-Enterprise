        ...
        function doModel()
        {
            ...
            switch ($this->action)
            {
                ...
                case('settings_post'):  // update item settings
                                        ...
                                        $enabledUserPublishing      = Params::getParam('enabled_user_publishing');
                                        $enabledUserPublishing      = (($enabledUserPublishing != '') ? true : false);
                                        ...
                                        $iUpdated += osc_set_preference('enabled_user_publishing', $enabledUserPublishing);
