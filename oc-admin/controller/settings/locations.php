            ...
            switch ($location_action) {
                case('add_country'):    // add country
                                        ...
                                        if(isset($exists['s_name'])) {
                                            osc_add_flash_error_message(sprintf(_m('%s was already in the database'), $countryName), 'admin');
                                        } else {
                ...
                case('edit_country'):   // edit country
                                        ...
                                        if(!osc_validate_min(Params::getParam('e_country'), 1)) {
                                            ...
                                            if( $ok ) {
                                                ...
                                                osc_add_flash_error_message(_m('There were some issues editing the country'), 'admin');
                                            }
                                        }
                                        $this->redirectTo(osc_admin_base_url(true) . '?page=settings&action=locations');
                break;
                ...
                case('add_region'):     // add region
                                        ...
                                        if(!osc_validate_min($regionName, 1)) {
                                            ...
                                            if(!isset($exists['s_name'])) {
                                                ...
                                                osc_add_flash_error_message(sprintf(_m('%s was already in the database'), $regionName), 'admin');
                                            }
                                        }
                                        osc_calculate_location_slug('region');
                                        osc_calculate_location_slug('city');
                ...
                case('edit_region'):    // edit region
                                        ...
                                        if(!osc_validate_min($newRegion, 1)) {
                                            ...
                                            if(!isset($exists['pk_i_id']) || $exists['pk_i_id']==$regionId) {
                                                ...
                                                osc_add_flash_error_message(sprintf(_m('%s was already in the database'), $newRegion), 'admin');
                                            }
                                        }
                ...
                case('add_city'):       // add city
                                        ...
                                        if(!osc_validate_min($newCity, 1)) {
                                            ...
                                            if(!isset($exists['s_name'])) {
                                                ...
                                                osc_add_flash_error_message(sprintf(_m('%s was already in the database'), $newCity), 'admin');
                                            }
                                        }
                                        osc_calculate_location_slug('city');
