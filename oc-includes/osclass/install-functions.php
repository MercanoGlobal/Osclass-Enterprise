        ...
        <div class="form-table">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="password" id="password" name="password" value="" size="25" autocomplete="off" required /></td>
            ...
            <table class="contact-info">
                ...
                <tr>
                    ...
                    <td><input type="text" id="email" name="email" size="25" /></td>
                     <td><span id="email-error" class="error" style="display:none;"><?php _e( 'Enter your e-mail here' ); ?></span></td>
                </tr>
                </tbody>
            </table>
