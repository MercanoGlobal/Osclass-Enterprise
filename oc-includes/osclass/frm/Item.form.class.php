 ...
 */
    ...
    class ItemForm extends Form {
        ...
        static public function region_select($regions = null, $item = null, $generate_all = false) {
            if($item==null) { 
                $item = osc_item(); 
            }
    ...
    $(document).ready(function(){
        ...
        $("form[name=item]").validate({
            ...
            messages: {
                ...
                <?php if($path == 'front') { ?>
                contactName: {
                    minlength: "<?php echo osc_esc_js(__("Name: enter at least 4 characters")); ?>.",
                ...
                <?php } ?>
                address: {
                    minlength: "<?php echo osc_esc_js(__("Address: enter at least 4 characters")); ?>.",
            ...
            <script defer>
                $(document).ready(function() {
                    ...
                    $('#restricted-fine-uploader').fineUploader({
                        ...
                        text: {
                            uploadButton: '<?php echo osc_esc_js(__('Click or Drop to upload images')); ?>',
                        ...
                        if (responseJSON.success) {
                            ...
                            if(parseInt(new_id)==0) {
                                $(li).append('<div class="primary_image primary"><?php echo osc_esc_js(osc_esc_html(__('Primary image'))); ?></div>');
                            } else {
