        ...
        $("form[name=register]").validate({
            ...
            messages: {
                s_name: {
                    ...
                    minlength: "<?php _e("Name: enter at least 4 characters"); ?>.",
                ...
                s_password: {
                    ...
                    minlength: "<?php _e("Password: enter at least 8 characters"); ?>."
                },
                s_password2: {
                    required: "<?php _e("Second password: this field is required"); ?>.",
                    minlength: "<?php _e("Second password: enter at least 8 characters"); ?>.",
