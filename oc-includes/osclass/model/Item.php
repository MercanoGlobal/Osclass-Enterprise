        ...
        public function extendDataSingle($item)
        {
            ...
            foreach ($descriptions as $desc) {
                if ($desc['s_title'] != "" || $desc['s_description'] != "") {
                    $desc['s_title'] = osc_apply_filter('item_title', $desc['s_title']);
                    $desc['s_description'] = osc_apply_filter('item_description', $desc['s_description']);
        ...
        public function extendData($items)
        {
            ...
            foreach ($items as $item) {
                ...
                foreach ($descriptions as $desc) {
                    if ($desc['s_title'] != "" || $desc['s_description'] != "") {
                        $desc['s_title'] = osc_apply_filter('item_title', $desc['s_title']);
                        $desc['s_description'] = nl2br(osc_apply_filter('item_description', $desc['s_description']));
