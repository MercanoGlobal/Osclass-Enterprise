...
function _osc_recaptcha_get_html($siteKey, $lang) {
    ...
    echo '<script type="text/javascript" src="https://www.google.com/recaptcha/api.js?hl=' . $lang . '" async defer></script>';
}
...
function osc_get_locations_json_url() {
    return 'https://raw.githubusercontent.com/Tangol/Osclass-Locations/main/locations/list.json';
}
/**
