 ...
 */
    ...
    */
    ...
    /**
     * Gets if only registered users can see phone
     *
     * @return boolean
     */
    ...
    /**
     * Gets if user listing publishing is enabled
     *
     * @return boolean
     */
    function osc_user_publishing_enabled() {
        return (getBoolPreference('enabled_user_publishing'));
    }
