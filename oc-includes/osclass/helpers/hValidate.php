 ...
 */
    ...
    */
     ...
     * @return boolean
     */
    function osc_validate_phone ($value = null, $count = 4, $required = false) {
     ...
     * Source: https://www.linuxjournal.com/article/9585?page=0,3
     *
     * @param string $email
     * @param boolean $required
     * @return boolean
     ...
     * @param $min
     */
    function osc_validate_username( $value, $min = 3 ) {
    ...
    /**
     * validate name, accept letters and spaces
     *
     * @param $value
     * @param $min
     */
    function osc_validate_name( $value, $min = 3 ) {
        if(mb_strlen($value, 'UTF-8') >= $min && preg_match('/^[a-zA-Z0-9][a-zA-Z0-9\s.+&amp;-]+$/',$value) ){
            return true;
        } else {
            return false;
        }
