    ...
    */
    ...
    function osc_static_page_url($locale = '') {
        if ( osc_rewrite_enabled() ) {
            ...
            $url = str_replace(array('{PAGE_ID}', '{PAGE_TITLE}'), array(osc_static_page_id(),osc_static_page_title()), str_replace('{PAGE_SLUG}', urlencode(osc_static_page_slug()), osc_get_preference('rewrite_page_url')));
            if($locale!='') {
