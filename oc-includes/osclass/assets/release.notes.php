                ...
                <td width="420" style="width: 420px;">
                    ...
                    <div style="font-size:13px; line-height:15px;color:#555555;">
                        <ul style="color:#555555;margin: 0;padding: 0;padding-left: 16px; list-style-type: disc !important;">
                            ...
                            <li>Added Anti Spam & Protection System v2.0 to the bundled plugins</li>
                            ...
                            <li>Added activity information in the admin dashboard (listings, users, comments)</li>
                            <li>Added System Configuration Info to the Admin Tools</li>
                            <li>Added CRON history in oc-admin > General Settings</li>
                            <li>Added Phone Number field on publish listings with show/hide settings</li>
                            <li>Added listing renewal feature for registered users</li>
                            <li>Added a new hook in the Main Admin Dashboard 'main_dashboard'</li>
                            <li>Added a new function 'osc_user_is_online' that returns true if user has been online in last 5 minutes and false otherwise</li>
                            <li>Added bot protection to the E-mail field on the item sidebar</li>
                            <li>Added the 7G Firewall to the Permalinks .htaccess</li>
                            <li>Added multiple password reset requests prevention (limit is set to 1 per hour)</li>
                            <li>Added search and pagination to Ban Rules</li>
                            <li>Added the ability to show the user avatar (set by plugins) in oc-admin > Users</li>
                            ...
                            <li>👉<a href="https://github.com/MercanoGlobal/Osclass-Enterprise/blob/main/CHANGELOG.txt" target="_blank">Full Changelog</a></li>
                        </ul>
                    </div>
                </td>
