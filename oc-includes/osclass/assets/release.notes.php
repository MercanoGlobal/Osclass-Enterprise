        ...
        <table height="5" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px; height: 12px; background-color: #f4f8fb; border: 0px; border-collapse: collapse; font-family: Arial, Helvetica, Verdana, sans-serif;">
            <tbody><tr valign="top">
                ...
                <td width="420" style="width: 420px;">
                    <div style="font-size:25px;line-height:25px;border-bottom:solid 1px #dbdbdb;padding-bottom:5px;padding-top:5px"><a href=" " style="color:#555555;text-decoration:none;">Osclass 3.8.0 highlights</a></div><img src="<?php echo osc_base_url().'oc-includes/osclass/assets/'; ?>images/t.gif" width="420" height="25" alt="">
                    <div style="font-size:13px; line-height:15px;color:#555555;">
                        <ul style="color:#555555;margin: 0;padding: 0;padding-left: 16px; list-style-type: disc !important;">
                            ...
                            <li>Support for MariaDB (mysql community) for Categories</li>
                            <li>Hooks at category insert & edit ('edited_category', 'add_category')</li>
                            <li>Filter at search page ('search_pattern')</li>
                            ...
                            <li>Updated PHPMailer to 5.2-stable</li>
