            ...
            <div id="container">
                                ...
                                <div class="requirements_help">
                                    ...
                                    <ul>
                                        <?php foreach($requirements as $k => $v) { ?>
                                            ...
                                            <?php } ?>
                                        <?php } ?>
                                        <li><a href=" " hreflang="en"><?php _e('Need more help?');?></a></li>
                                    </ul>
                                </div>
                            <?php } else { ?>
                                <p><?php _e('All right! All the requirements have been met:');?></p>
                            <?php } ?>
                            <ul>
                                <?php foreach($requirements as $k => $v) { ?>
                ...
                <div id="footer">
                    <ul>
                        ...
                        <li>
                            <a href="https://github.com/MercanoGlobal/Osclass-Enterprise" target="_blank" hreflang="en"><?php _e( 'Feedback' ); ?></a>
                        </li>
                        <li>
