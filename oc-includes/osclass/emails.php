 ...
 */
    ...
    function fn_email_item_inquiry($aItem) {
        ...
        if( osc_item_attachment() ) {
            ...
            if( !is_writable(osc_uploads_path()) ) {
                osc_add_flash_error_message( _m("We've encountered some errors while sending the message") );
            }
    ...
    function fn_email_auto_upgrade($result) {
        ...
        $body .= '<p><a href="https://www.valueweb.gr/forums/osclass-enterprise-release/">https://www.valueweb.gr/forums/osclass-enterprise-release/</a></p>';
